...
export default function OrderDetailPage({ params }: OrderDetailPageProps) {
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="flex flex-col gap-3 sm:gap-4">
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="p-1 sm:p-1.5 lg:p-2 bg-primary/10 rounded-lg">
                  <Package className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-primary" />
                </div>
                <div className="min-w-0">
                  <h1 className="text-base sm:text-lg lg:text-2xl xl:text-3xl font-serif font-bold text-foreground truncate">
      ...
      {/* Order Status */}
      <div className="container mx-auto px-3 sm:px-4 lg:px-6 xl:px-8 py-3 sm:py-4 lg:py-8">
        <div className="max-w-6xl mx-auto">
          <div className="bg-card rounded-xl border border-border/50 overflow-hidden mb-3 sm:mb-4 lg:mb-8">
            <div className="p-3 sm:p-4 lg:p-6">
              <div className="flex flex-col gap-3 sm:gap-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div className="flex-1">
                    <span className={`px-2 sm:px-2.5 py-1 rounded-full text-xs font-medium ${getStatusColor(order.status)}`}>
                  ...
                  <div className="text-left sm:text-right">
                    ...
                    <p className="text-lg sm:text-xl lg:text-2xl font-serif font-bold text-primary">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-8">
            ...
            <div className="lg:col-span-2 space-y-3 sm:space-y-4 lg:space-y-6">
              {order.subOrders.map((subOrder) => (
                ...
                >
                  {/* Seller Info */}
                  <div className="p-3 sm:p-4 lg:p-6 border-b border-border/30">
                    <div className="flex items-center gap-2 sm:gap-3 lg:gap-4">
                      <S3Image
                        ...
                        width={40}
                        height={40}
                        className="w-7 h-7 sm:w-8 sm:h-8 lg:w-10 lg:h-10 rounded-full object-cover flex-shrink-0"
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex flex-wrap items-center gap-1 sm:gap-1.5 lg:gap-2 text-xs sm:text-sm text-muted-foreground mt-1">
                          ...
                          {subOrder.sellerDetails.isVerified && (
                            <span className="seller-verified px-1 sm:px-1.5 py-0.5 rounded-full text-xs whitespace-nowrap">
                              Verified
                            </span>
                          )}
                        </div>
                  ...
                  <div className="p-3 sm:p-4 lg:p-6">
                    <div className="space-y-3 sm:space-y-4 lg:space-y-6">
                      {subOrder.items.map((item) => (
                        <div key={item._id} className="flex items-start gap-2 sm:gap-3 lg:gap-4">
                          <S3Image
                    ...
                    {/* Subtotal */}
                    <div className="mt-3 sm:mt-4 lg:mt-6 pt-3 sm:pt-4 lg:pt-6 border-t border-border/30">
                      ...
                      <div className="flex justify-between items-center mt-1 sm:mt-1.5 lg:mt-2 text-sm sm:text-base lg:text-lg font-medium">
                        <span>Total</span>
            ...
            <div className="space-y-3 sm:space-y-4 lg:space-y-6">
              ...
              <div className="bg-card rounded-xl border border-border/50 overflow-hidden">
                <div className="p-3 sm:p-4 lg:p-6">
                  <h3 className="font-serif font-bold text-sm sm:text-base lg:text-lg mb-2 sm:mb-3 lg:mb-4 flex items-center gap-1.5 sm:gap-2">
                    <MapPin className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 text-primary" />
                    Shipping Details
                  </h3>
              ...
              <div className="bg-card rounded-xl border border-border/50 overflow-hidden">
                <div className="p-3 sm:p-4 lg:p-6">
                  <h3 className="font-serif font-bold text-sm sm:text-base lg:text-lg mb-2 sm:mb-3 lg:mb-4 flex items-center gap-1.5 sm:gap-2">
                    <FileText className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 text-primary" />
                    Payment Details
                  </h3>
                  <div className="space-y-2 sm:space-y-3 lg:space-y-4">
                    <div>
                        ...
                        {order.paymentDetails.method === 'bank-transfer' && 
                         order.paymentDetails.status === 'processing' && (
                          <button
                            ...
                            className="flex items-center justify-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1 sm:py-1.5 text-xs font-medium text-orange-700 bg-orange-50 hover:bg-orange-100 border border-orange-200 rounded-lg transition-colors dark:text-orange-300 dark:bg-orange-900/20 dark:hover:bg-orange-900/30 dark:border-orange-800"
                          >
                            <Upload className="w-3 h-3 flex-shrink-0" />
                            <span className="hidden sm:inline">Re-upload Receipt</span>
