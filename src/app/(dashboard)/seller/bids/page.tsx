...
import SellerBidDashboard from '@/components/dashboards/SellerBidDashboard'
import { BarChart3, Star, Gem, RefreshCw } from 'lucide-react'
...
export default function SellerBidsPage() {
  ...
  return (
    <>
      <PageTitle title="Auction Management" />
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Monitor and manage bids for your auction listings on <span className="font-semibold text-primary">Ishq Gems</span>
                </p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div className="hidden lg:flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-lg">
                ...
                <span className="text-sm font-medium text-primary">Auction Dashboard</span>
              </div>
            </div>
          </div>
        </div>
